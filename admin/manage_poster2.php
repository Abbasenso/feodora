...
if(isset($_GET['id']) && $_GET['id']!=''){
	...
	$res=mysqli_query($con,"select * from banner3 where id='$id'");
	...
	if($check>0){
     ...
     <script>
    window.location.href='poster2.php';
    </script>
	<?php
		die();
	}
...
if(isset($_POST['submit'])){
	...
	if($msg==''){
        ...
        if($_FILES['image']['name']!=''){
				...
				move_uploaded_file($_FILES['image']['tmp_name'],POSTER2_IMAGE_SERVER_PATH.$image);

				mysqli_query($con,"update banner3 set heading1='$heading1',btn_link='$btn_link',image='$image',order_by='$order_by' where id='$id'");
			}
			else{
				mysqli_query($con,"update banner3 set heading1='$heading1',btn_link='$btn_link',order_by='$order_by' where id='$id'");
			}
			...
			mysqli_query($con,"insert into banner3(heading1,btn_link,image,status,order_by) values('$heading1','$btn_link','$image','1','$order_by')");
		}
	//	header('location:poster2.php');
                     ...
                     <div class="card">
                        ...
                        <form method="post" enctype="multipart/form-data">
							<div class="card-body card-block">
                              ...
                              if ($image!='') {
                              	echo "<a target='_blank' href='".POSTER2_IMAGE_SITE_PATH.$image."'><img width='100px' height='100px' src='".POSTER2_IMAGE_SITE_PATH.$image."'/></a>";
                              }
									 ?>
								</div>
