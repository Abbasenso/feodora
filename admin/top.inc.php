         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="poster.php" > Poster Master</a>
                  </li>

                  <li class="menu-item-has-children dropdown">
                     <a href="poster2.php" >Down Poster Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
                     ...
                     <li class="menu-item-has-children dropdown">
                     <a href="banner_c.php" > Categories Banner</a>
                  </li>
                   <li class="menu-item-has-children dropdown">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="coupon_master.php" > Cupon_Master</a>
                  </li>
                  <li class="menu-item-has-children dropdown">
				  ...
				  <li class="menu-item-has-children dropdown">
                   ...
                   <li class="menu-item-has-children dropdown">
                     <a href="review.php" > Review Master</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
