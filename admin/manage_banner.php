...
if(isset($_POST['submit'])){
	...
	if($msg==''){
        ...
        if($_FILES['image']['name']!=''){
				...
				mysqli_query($con,"update banner set heading1='$heading1',btn_link='$btn_link',image='$image',order_by='$order_by' where id='$id'");
			}
			else{
				mysqli_query($con,"update banner set heading1='$heading1',btn_link='$btn_link',order_by='$order_by' where id='$id'");
			}
			...
			mysqli_query($con,"insert into banner(heading1,btn_link,image,status,order_by) values('$heading1','$btn_link','$image','1','$order_by')");
		}
	//	header('location:banner.php');
...
<div class="content pb-0">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong></strong><small> Form Banner</small></div>
