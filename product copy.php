                ...
                <!-- <div class="container">
                    <div class="row">
                        <div class="col-sm-8 alert alert-danger" role="alert">
                            <a href="car4t.php"><img src="<?php //echo 'media/product/'.$image; ?>" alt="product img" width="35px"/></a>
                            Added to Cart 
                            Cart Product (<?php //echo $totalProduct?> item) : 
                            <button type="button" class="btn btn-warning">Cart</button>
                            <button type="button" class="btn btn-info"> Proceed to Buy (<?php //echo $totalProduct?> item)  </button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                if($cart_show!=''){
                                ?>
                                <a class="fr__btn" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id']?>','add','redir'); setTimeout()">Add to cart</a>
