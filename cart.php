                            ...
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <td class="product-thumbnail"><a href="#"><img src="<?php echo 'media/product/'.$image; ?>" alt="product img" /></a></td>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        ...
                                        <div class="buttons-cart checkout--btn">
                                            ...
                                            <a href="checkout.php">Proceed to Buy</a>
                                        </div>
                                        <?php
                                        //   foreach ($_SESSION['cart'] as $key => $val) {
                                        //     $productArr=get_product($con,'','',$key,'','');
                                        //     //pr($productArr);
                                        //     echo $productArr['0']['name'];
                                        //     echo $productArr['0']['mrp'];
                                        //     echo $productArr['0']['price'];
                                        //     echo $productArr['0']['image'];
                                        //     echo $val['qty'];
