...
//prx($_SESSION);
       ...
       foreach ($_SESSION['cart'] as $key => $val) {
        ...
        $cat=mysqli_query($con, "SELECT * FROM `product` WHERE id=$key");
        $rowid=mysqli_fetch_assoc($cat);
        //echo $rowid['id'];
       


$cat_id=mysqli_real_escape_string($con,$rowid['categories_id']);
if ($cat_id > 0) {
                 ...
                 <div class="row">
                     ...
                     <div class="row">
                         ...
                         <div class="col-sm-8 alert alert-danger" role="alert">
                             <a href="cart.php"><img src="<?php echo 'media/product/'.$image; ?>" alt="product img" width="35px"/></a>
                              Added to Cart Total : (<?php echo $totalProduct?> item) 
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
